...
import (
	...
	ex2_5_popcount "GoLearning/Chapter/ch2/ch2_6_package_and_file/ex2_5/popcount"
...
func main() {
	...
	start = time.Now()
	for i := 0; i < 1000000; i++ {
		ex2_5_popcount_value = ex2_5_popcount.PopCount(0x1234567890ABCDEF)
	}
	time_spent = time.Since(start).Nanoseconds()
	fmt.Printf("%-25s %v ns\n", "ex2_5_popcount.PopCount:", time_spent)

	fmt.Printf("%-25s %v\n", "popcount.PopCount:", popcount_value)
	fmt.Printf("%-25s %v\n", "ex2_3_popcount.PopCount:", ex2_3_popcount_value)
	fmt.Printf("%-25s %v\n", "ex2_4_popcount.PopCount:", ex2_4_popcount_value)
	fmt.Printf("%-25s %v\n", "ex2_5_popcount.PopCount:", ex2_5_popcount_value)
}
