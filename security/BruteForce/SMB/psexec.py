            ...
            while True:
                try:
                    ...
                    try:
                        ...
                        endsWithPrompt = bool(
                            re.match(promptRegex, __stdoutOutputBuffer) is not None
                        )
...
if __name__ == "__main__":
    ...
    group.add_argument(
        "-remote-binary-name",
        action="store",
        metavar="remote_binary_name",
        default=None,
        help="This will " "be the name of the executable uploaded on the target",
    )
